                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Login untuk melihat admin E-Commerce.</p>
                                </div>
                                @if ($errors->any())
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Belum memiliki akun ? <a href="/register" class="fw-semibold text-primary text-decoration-underline"> Daftar </a> </p>
                        </div>
